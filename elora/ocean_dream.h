...
#define WIDTH OLED_DISPLAY_HEIGHT //OLED_DISPLAY_HEIGHT            // for vertical displays
#define HEIGHT OLED_DISPLAY_WIDTH  //OLED_DISPLAY_WIDTH            // for vertical displays
...
#define WAVE_HURRICANE 45    // render heavy waves above this WPM
